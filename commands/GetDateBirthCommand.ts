...
export default class GetDateBirthCommand extends BaseCommand {
   ...
   */
  public static commandName = 'get:date_birth_command'
  /**
  ...
  public async run() {
    ...
    for (const [index, check] of Object.entries(this.check.data)) {
      try {
        ...
        //token da conta alberttttojrfsa@gmail.com
        const urlHub = 'https://ws.hubdodesenvolvedor.com.br/v2/nome_cpf/?cpf=' + check.cpf + '&token=135686940YSmHLpbjTv244978656';
